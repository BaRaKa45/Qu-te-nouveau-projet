...
class User
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="AppBundle\Entity\Reservation", mappedBy="passager")
     */
    private $passagers;
     ...
     * Add passager
     *
     * @param \AppBundle\Entity\Reservation $passager
     *
     * @return User
     */
    public function addPassager(\AppBundle\Entity\Reservation $passager)
    {
     ...
     * @param \AppBundle\Entity\Reservation $passager
     */
    public function removePassager(\AppBundle\Entity\Reservation $passager)
    {
